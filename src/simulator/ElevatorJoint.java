...
public class ElevatorJoint extends AbstractControl{
	...
	public void setSpatial(Spatial spatial) {
		...
		constraints = new SixDofJoint(baseControl, ctrl, new Vector3f(0f, 0f, 0f), new Vector3f(0f, 0f, 0f), false);
		...
		//		constraints.getTranslationalLimitMotor().setLowerLimit(new Vector3f(-100f, -100f, 2f));
	}
...
//		ctrl.applyCentralForce(new Vector3f(0f, mtrPwr*200, 0f));
	}
}