...
public class FieldAppState extends BaseAppState {
	...
	private void createHabs() {
		...
		habCtrlRamp.setPhysicsLocation(new Vector3f(-5.55f, 0f, .1f));
		...
		habCtrl.setPhysicsLocation(new Vector3f(-6.1f, 0f, .1f + HAB_HEIGHTS[0]));
		...
		hab.addControl(habCtrl);
		hab.setMaterial(blueHabMat);
		habCtrl.setPhysicsLocation(new Vector3f(-7.2f, 0f, .1f + HAB_HEIGHTS[1]));
		app.getPhysicsSpace().add(hab);
		rootNode.attachChild(hab);
		...
		hab.addControl(habCtrl);
		hab.setMaterial(blueHabMat);
		habCtrl.setPhysicsLocation(new Vector3f(-7.2f, 0f, .1f + HAB_HEIGHTS[2] + HAB_HEIGHTS[1]));
		app.getPhysicsSpace().add(hab);
		rootNode.attachChild(hab);
